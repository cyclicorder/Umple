...
public class Person
{
  ...
  // line 35 "model.ump"
   public static  void main(String [] args){
    ...
    while(true)
    {
    	if(m.numberOfStudents()<m.maximumNumberOfStudents())
    	{
    		String sname;
    		    
    		    Student s = new Student("Tom The Student");
    		    Student t = new Student("Tommy The Student");
    		    Student u = new Student("Tomus The Student");
    		    Student v = new Student("Tomtom The Student");
    		    Student w = new Student("Tomato The Student");
    		    Student x = new Student("Tomcat The Student");
    		    Student y = new Student("Tomjet The Student");
    		    s.setMentor(m);
    		    t.setMentor(m);
    		    u.setMentor(m);
    		    v.setMentor(m);
